          ...
          <div id="printTable">
            <header>
              <div style="width: 60%;float: left;padding: 8px;margin-bottom: 5px;">
                <p style="margin:0;font-size: 18px;font-weight: bolder;">
                ...
                <ul style="list-style: none;font-size: 14px;margin:0px;">
                  ...
                  <!--<li style="margin:0px;"><span style="font-weight: bold;">Website</span>: www.itpal.com.bd</li>-->
                </ul>
              </div>
              <div style="padding: 8px;min-height: 0px;margin-bottom: 5px;">
                <p style="text-align: center;font-size: 20px;font-weight: bolder;margin:0px;">Purchase Slip</p>
                <ul style="list-style: none;font-size: 14px;margin:0;line-height: 22px;">
              ...
              <div style="width: 100%;min-height: 330px;border: 2px solid #000;border-top: 0px;" class="product">
                ...
                <thead>
                  <tr>
                    ...
                    <th style="border:2px solid #000;font-size: 16px;background: #ddd;text-align: center;">Amount(<?php echo $farjan->amountsymbol;?>)</th>
                  </tr>
                </thead>
                <tbody>
                <?php
            ...
            <footer>
              ...
              <tt style="font-size: 12px; text-align: center;margin-top: 0px;display: block;">This software is developed by IT Pal Limited (www.itpal.com.bd)</tt>
            </footer>
          </div>
          </div>
        </div>
