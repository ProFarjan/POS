...
<?php
 ...
 if ($_SERVER['REQUEST_METHOD'] == "POST" AND isset($_POST['personcash'])) {
   $addcustomer = $cu->Bank_Cash_Out_List($_POST);
 }
      ...
      <div class="title_right">
        <div class="col-md-3 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            <a href="banktransferlist.php" class="btn btn-info">Bank Withdraw List</a>
          </div>
        </div>
      </div>
    </div>
...
<form class="form-horizontal form-label-left" action="" method="post" enctype="multipart/form-data">
  ...
  <div class="item form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Withdraw Slip No <span class="required"></span>
    </label>
    <div class="col-md-6 col-sm-6 col-xs-12">
