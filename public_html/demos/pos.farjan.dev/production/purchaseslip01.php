    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div id="printTable" style="width: 320px;margin: 0 auto;">
<style type="text/css">
/* vietnamese */
@font-face {
...
@font-face {
  ...
  unicode-range: U+0000-00FF, U+0131, U+0152-0153, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2212, U+2215;
            ...
            <header>
              <div style="width: 100%;margin: 0 auto;text-align: center;padding-bottom: 15px;">
                ...
                <ul style="list-style: none;font-size: 14px;margin:0px;">
                  ...
                  <!--<li>Date: <span style="background: #ddd;padding: 0 15px;"><?php echo $cust1->date;?></span></li>
                  <li>Purchase No: &nbsp;&nbsp;&nbsp;<span style="border: 1px solid #ddd;padding: 0 15px;"><?php echo $invoice;?></span></li>
                  <li>Supplier Name: &nbsp;<span style="border: 1px solid #ddd;padding: 0 15px;"><?php echo $cust->name;?></span></li>
                  <li>Supplier Phone: &nbsp;<span style="border: 1px solid #ddd;padding: 0 15px;"><?php echo $cust->phone;?></span></li>-->
                </ul>
              </div>
            </header>
            ...
            <main>
              <div style="width: 100%;margin-bottom: 15px;">
                <table style="width: 100%;text-align: left;">
                  ...
                  <tr>
                    <td style="font-size: 13px;">Purchase No. <?php echo $invoice;?></td>
                    <td style="font-size: 13px;">Supplier ID. <?php echo $cust->customerid;?></td>
                  </tr>
                  <tr>
              ...
              <div style="padding-bottom: 15px;" class="product">
                ...
                <thead>
                  <tr style="border-bottom: 1px solid;">
                    ...
                    <th style="font-weight: bolder;font-size: 12px;">Items</th>
                    <th style="font-weight: bolder;font-size: 12px;">Qty</th>
                    <th style="font-weight: bolder;font-size: 12px;">Price</th>
                    <th style="font-weight: bolder;font-size: 12px;">Amount(<?php echo $farjan->amountsymbol;?>)</th>
                  </tr>
                </thead>
                <tbody>
                <?php
              ...
              <div style="margin-top: 5px;">
                <table style="width: 100%;">
                  <tr>
                    <td style="font-size: 13px;text-align: left;">Sub Total</td>
                  ...
                  <tr>
                    <td style="font-size: 13px;text-align: left;">Discount</td>
                    <td style="font-size: 13px;text-align: right;"><?php
            ...
            <div style="overflow: hidden;"></div>
            <section>
              <p style="font-size: 10px;text-align: center;font-family: 'Pacifico', cursive;">Thank You For Your Business</p>
            </section>
          </div>
          </div>
        </div>
