...
<?php
  $po = new Store();
  $product = $po->Total_Pay_Rece_Report('1');
?>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <div id="printTable">
            <div class="myreport">
            <h2 style="text-align: center;margin-top: 0;margin-bottom: 4px;">Receiable Report</h2>
                ...
                <?php
                        ...
                        if ($product) {
                          while ($data = $product->fetch(PDO::FETCH_OBJ)) { $i++;
                            $totalval = $po->F_Receiable_Total_amount($data->customerid);
                      ...
                      <?php }}} ?>
                      <tr>
                        <td colspan="3" style="padding: 5px 0px;border: 1px solid;text-align: right;"></td>
                        <td style="padding: 5px 0px;border: 1px solid;text-align: center;"><?php echo $g_total;?></td>
                        <td style="padding: 5px 0px;border: 1px solid;text-align: center;"><?php echo $g_paid;?></td>
                        <td style="padding: 5px 0px;border: 1px solid;text-align: center;"><?php echo $g_due;?></td>
                      </tr>
              </table>
            </div>
            </div>
